...
CREATE TABLE IF NOT EXISTS cars (
  ...
  photo_position_x VARCHAR(10) NOT NULL DEFAULT 'center',
  photo_position_y VARCHAR(10) NOT NULL DEFAULT 'center',
  photo_focus_x TINYINT UNSIGNED NULL,
  photo_focus_y TINYINT UNSIGNED NULL,
