...
<head>
  ...
  <title>Ilk Kurulum | RentecarWeb</title>
...
<body class="auth-page">
  <div class="auth-shell">
    <div class="auth-card shadow-sm auth-card-wide">
      ...
      <h1>Ilk Kurulum</h1>
      <p class="auth-subtitle">Ilk firma ve yonetici kullaniciyi olusturalim.</p>
      ...
      <form action="actions/setup_admin.php" method="post" class="auth-form">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            <label class="form-label">Yonetici Ad Soyad</label>
